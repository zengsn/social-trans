...
<div class="xzfw" style="width: 210px;">
    <div class="xzfw_nav" style="width:214px;min-height:500px;">
        <div class="nBox" style="width:214px;">
            ...
            <div class="sm">
            	<dl class="">
                    <dt><a class="yh" href="${ctx }/user_listUI.action" target="mainFrame"><b></b>用户管理<s class="down"></s>
                    </a></dt>
                </dl>
				<dl class="">
                    <dt><a class="yh" href="${ctx }/role_listUI.action" target="mainFrame"><b></b>角色管理<s class="down"></s>
                    </a></dt>
                </dl>
