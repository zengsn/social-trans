 ...
 * 
 * 
 * Website: http://git.oschina.net/hbbcs/bootStrap-addTabs Version : 1.0 Created
 * by joe on 2016-2-4.
 * 
 * 
 */
...
$.fn.addtabs = function(options) {
	...
	Addtabs.options = $.extend({
		...
		iframeHeight : $(document).height() - 123, // 固定TAB中IFRAME高度,根据需要自己修改
		method : 'init',
...
window.Addtabs = {
	...
	add : function(opts) {
		...
		if (!$("#" + id)[0]) {
			...
			if ($("#" + id).find("iframe")[0]) {
				$("#" + id).find("iframe")[0].contentDocument.location.reload();
