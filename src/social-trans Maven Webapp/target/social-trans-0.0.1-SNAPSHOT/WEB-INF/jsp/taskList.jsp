                                                ...
                                                <article class="format-standard type-post hentry clearfix">
                                                        ...
                                                        <header class="clearfix">
                                                                ...
                                                                <div class="post-meta clearfix">
                                                                        ...
                                                                        <span class="category"><a href="#" title="View all posts in Server &amp; Database">${item.taskMoney}</a></span>
                                                                        <span class="comments"><a href="#" title="Comment on Integrating WordPress with Your Website">${item.description}</a></span>
